...
// nodeGeneName
  ...
  methods: {
    ...
    async tryARAX() {
      ...
      // console.log(twohopdata)
      let araxResults = await ARAXService.araxQuery()
    ...
    async testSection() {
      ...
      // for (let i = 0; i < this.hgncAll.length; i++) {
      //   const geneID = this.hgncAll[i];
      //   this.concept_search = geneID
      //   this.getAllSynToDrugs()
